...
prompt_with_default "API Base URL" "http://localhost:8080" API_BASE_URL
...
if command -v jq &> /dev/null; then
    ...
    echo "⚠️  jq not found. Please manually update the 'name' field in package.json"
fi
