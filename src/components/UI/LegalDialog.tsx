    ...
    sections: [
      {
        ...
        content: 'By accessing and using Future Citizen services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.'
      },
      {
        title: '2. Service Description',
        content: 'Future Citizen provides digital spiritual services including AI-powered puja ceremonies, personalized chanting, and virtual religious guidance. Our services are designed to complement, not replace, traditional religious practices.'
      },
      {
      ...
      },
      {
        ...
        content: 'All AI-generated content, including chants, ceremonies, and avatar representations, remain the intellectual property of Future Citizen. Users may not record, distribute, or commercialize our content without explicit permission.'
      },
      {
        title: '6. Limitation of Liability',
        content: 'Future Citizen provides digital spiritual services for educational and devotional purposes. We are not liable for any spiritual, emotional, or personal outcomes resulting from use of our services.'
      },
      {
      ...
      },
      {
        ...
        content: 'Future Citizen reserves the right to modify these terms at any time. Users will be notified of significant changes via email or through our platform.'
      }
    ]
        };
      case 'privacy':
          ...
          sections: [
            {
              ...
              content: 'Once a puja booking is confirmed and payment is processed, no cancellations are allowed. This policy ensures that our Future Citizens can prepare personalized content and maintain the sacred scheduling of ceremonies.'
            },
            {
            ...
            },
            {
              ...
              content: 'Refunds are only provided in cases where Future Citizen fails to deliver the booked service due to technical failures on our platform. Customer-side technical issues, change of mind, or scheduling conflicts do not qualify for refunds.'
            },
            {
          ...
          sections: [
            {
              ...
              content: 'Future Citizen provides exclusively digital spiritual services. No physical products are shipped or delivered. All puja ceremonies, chanting sessions, and spiritual guidance are delivered through our online platform.'
            },
            {
            ...
            },
            {
              ...
              content: 'We do not provide physical puja materials, idols, or ceremonial items. Customers are responsible for arranging their own puja materials as guided by our Future Citizen during the session.'
            },
            {
              ...
              <div className="text-sm text-gray-600 bg-orange-50 p-4 rounded-lg border border-orange-200">
                ...
                <p>
                  This {
                    ...
                    'Policy'
                  } governs your use of Future Citizen services. 
