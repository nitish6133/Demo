...
import { ObjectType, OBJECT_COLORS, OBJECT_ICONS } from '../types/urbanTypes';
...
export function LayerControl() {
  ...
  return (
    <div className="absolute bottom-4 left-4 bg-white rounded-lg shadow-xl p-4 z-10 w-64">
