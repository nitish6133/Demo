            ...
            <div className="p-8">
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <motion.button
                  ...
                  className={`w-full py-3 rounded-2xl font-bold text-lg flex items-center justify-center gap-3 shadow-fun transition-all duration-300 text-white ${isFormValid && !authLoading
                      ? "cursor-pointer"
